  ...
  useEffect(() => {
    const fetchLeaveRequests = async () => {
      try {
        ...
        const res = await api.get('/leave/fla/upcoming', { params: requestBody });
  ...
  return (
    <div className="container mt-4">
      ...
      {leaveRequests.length === 0 ? (
        <p className="text-muted">No upcoming leave applications for FLA.</p>
      ) : (
